...
export default function MockupPresentation({ chapter }: Props) {
  const accent = chapterAccentHex(chapter);
    ...
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <main className="relative z-10 h-full w-full flex items-center justify-center pt-20 pb-32">
        ...
        >
          <SlideStage>
            <SlideFrame>
            <div className="relative flex-1 flex flex-col gap-10 justify-center items-center text-center">
              <div
              ...
              />
              <div className="relative z-10 flex flex-col gap-10 justify-center items-center text-center w-full">
                <span
